...
export const Contact: React.FC = () => {
  ...
  return (
    <div className="space-y-16 pb-16">
      ...
      {/* WALK-IN REGISTRATION NOTICE BANNER & INQUIRY FORM */}
              ...
              <form onSubmit={handleSubmit} className="space-y-4 text-xs">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-slate-50 dark:bg-slate-800 rounded-xl text-xs text-slate-900 dark:text-white border border-slate-200 dark:border-slate-700 focus:outline-none focus:ring-2 focus:ring-medical-500"
                    />
                  </div>
                ...
                <div className="space-y-1">
                  ...
                  <input
                    type="text"
                    required
                    placeholder="e.g. Microscopic ear surgery query, Sinus consultation"
                    value={subject}
                ...
                <div className="space-y-1">
                  ...
                  <textarea
                    rows={4}
                    required
                    placeholder="Describe your query or symptoms here..."
                    value={message}
      ...
      {/* BRANCH CONTACT & MAPS CARDS */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        {BRANCHES.map((branch) => (
          <div 
            key={branch.id}
            className="glass-card rounded-3xl p-6 sm:p-10 border border-slate-200/80 dark:border-slate-800 shadow-xl"
          >
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              
              <div className="lg:col-span-6 space-y-6">
                <div>
                  <span className={`inline-block text-[10px] uppercase font-bold tracking-widest px-3 py-1 rounded-full mb-2 ${
...
<div className="flex flex-wrap gap-3 pt-2">
                ...
                <div className="flex flex-wrap gap-3 pt-2">
                  <a
                    href={`tel:${branch.phone}`}
                    className="flex-1 py-3 bg-medical-600 hover:bg-medical-700 text-white font-semibold text-xs rounded-xl text-center shadow transition-colors flex items-center justify-center gap-2"
                  >
                  ...
                  <a
                    ...
                    className="flex-1 py-3 bg-white dark:bg-slate-800 hover:bg-slate-100 dark:hover:bg-slate-700 text-slate-800 dark:text-slate-100 border border-slate-300 dark:border-slate-700 font-semibold text-xs rounded-xl text-center shadow-sm transition-colors flex items-center justify-center gap-2"
                  >
